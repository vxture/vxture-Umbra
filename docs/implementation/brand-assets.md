...
| `brand/umbra-symbol-dark.png` | Yes | 256x256 | Header/admin mark on dark surfaces |
| `brand/umbra-symbol-light.png` | Yes | 256x256 | Header mark on light surfaces |
| `brand/umbra-hero-dark.png` | Yes | 720x360 | Website hero/signature image in dark mode |
| `brand/umbra-hero-light.png` | Yes | 720x360 | Website hero/signature image in light mode, Open Graph, Twitter card |
