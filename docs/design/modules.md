...
- The dashboard reads the stored subscription URL on normal page views. The `Update subscription URL` button refreshes the current `subscription_url` from Marzban by bound user code, then updates the local account cache.
