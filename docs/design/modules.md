...
| `03-vpn-portal.conf.template` | `EDGE_DOMAIN` | `umbra-account:8081`, with `/guide/` to `umbra-portal:80` |
| `04-sub.conf.template` | `sub.ruyin.ai` | `umbra-subproxy:8080` for native Marzban `/sub/<token>` metadata normalization |
| `05-console.conf.template` | `console.ruyin.ai` | `umbra-marzban:8000` + `/invites/` to `umbra-account:8081` |
...
Browser -> console.ruyin.ai/invites/
  Nginx -> umbra-account
...
## Module 5: Account Portal (vpn.ruyin.ai)
