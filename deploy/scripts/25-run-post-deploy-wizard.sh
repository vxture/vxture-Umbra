#!/usr/bin/env bash
# Post-deployment wizard. Run after deploy.sh all completes.
...
echo ""
echo "  Vaultwarden is running at https://$PAS_DOMAIN"
echo ""
echo "  Steps to complete:"
echo "    1. Open the admin panel: https://$PAS_DOMAIN/admin"
...
echo "       * HTTPS https://$SUB_DOMAIN  (subscription / nginx)"
echo ""
