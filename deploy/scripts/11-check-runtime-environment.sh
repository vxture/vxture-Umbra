...
REQUIRED_VARS=(
  ...
  HYSTERIA_PASSWORD HYSTERIA_OBFS_PASSWORD
...
for domain_var in APEX_DOMAIN WWW_DOMAIN EDGE_DOMAIN SUB_DOMAIN CONSOLE_DOMAIN ADMIN_DOMAIN PAS_DOMAIN REALITY_SNI; do
