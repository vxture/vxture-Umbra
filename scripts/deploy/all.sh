...
echo ""
echo "  Account Portal: https://$EDGE_DOMAIN"
echo "  Invite Console: https://$CONSOLE_DOMAIN/invites/"
...
echo "  2. Open https://$CONSOLE_DOMAIN/invites/ to generate user invites"
