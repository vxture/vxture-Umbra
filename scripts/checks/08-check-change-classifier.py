...
CASES = [
    ...
    ("no changes", [], False, []),
    ("website source", ["portals/website/app/page.tsx"], True, ["ruyin-website"]),
    ("console source", ["portals/console/app/page.tsx"], True, ["ruyin-console"]),
    ("admin source", ["portals/admin/app/page.tsx"], True, ["ruyin-admin"]),
