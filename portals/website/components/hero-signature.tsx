 ...
 * it recolor instantly with the theme via `currentColor` (driven by
 * .hero-signature-art in globals.css) instead of swapping a per-theme PNG, which
 * reloaded an image and stuttered on every theme toggle. Decorative: the
 * accessible name is the sr-only <h1> in hero-section.tsx, so this is
 * aria-hidden. Source: brand/ruyin-hero.svg (keep the two in sync).
 */
